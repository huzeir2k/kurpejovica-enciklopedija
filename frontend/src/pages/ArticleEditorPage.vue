  ...
  <div class="article-editor-page">
    ...
    <div v-if="!selectedArticle && !isNewArticle" class="article-list-section">
      <div class="section-header">
        <h2>Articles</h2>
        <button @click="startNewArticle" class="btn btn-primary">+ New Article</button>
      </div>
    ...
    <div v-if="selectedArticle || isNewArticle" class="editor-section">
      <div class="editor-header">
        <button @click="closeEditor" class="btn btn-secondary">← Back</button>
      ...
      <div class="editor-form">
        ...
        <div v-if="isNewArticle" class="form-group">
          <label>Select Family Member</label>
          <select v-model="formData.family_member_id" class="form-control">
        ...
        <div v-if="isNewArticle" class="form-group">
          ...
          <select v-model="formData.language" class="form-control">
            <option value="sr">Serbo-Croatian</option>
        ...
        <div v-if="isNewArticle" class="form-group">
          ...
          <select v-model="selectedTemplate" class="form-control">
            <option value="basic">Basic (Section + Paragraph)</option>
            <option value="infobox">With Infobox</option>
            <option value="fullFeatured">Full Featured (Wikipedia-style)</option>
          </select>
        </div>
        ...
        <div class="editor-toolbar">
          <button @click="insertTemplate('infobox')" class="btn btn-small">Insert Infobox</button>
          <button @click="insertTemplate('section')" class="btn btn-small">Insert Section</button>
          <button @click="insertTemplate('table')" class="btn btn-small">Insert Table</button>
        </div>
        ...
        <div class="form-actions">
          <button @click="saveArticle" :disabled="saving" class="btn btn-primary">
            {{ saving ? 'Saving...' : 'Save Article' }}
          </button>
          <button v-if="!isNewArticle" @click="deleteArticle" class="btn btn-danger">
            Delete Article
          </button>
          <button @click="closeEditor" class="btn btn-secondary">Cancel</button>
        </div>
      ...
      <div v-if="!isNewArticle" class="translations-section">
        ...
        <button @click="translateArticle" class="btn btn-secondary">
        ...
        <div class="images-list">
          ...
          >
            ...
            <div class="image-info">
              ...
              <button @click="deleteImage(image.id)" class="btn btn-small btn-danger">
                Delete
              </button>
            </div>
          </div>
